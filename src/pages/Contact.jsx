      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 hover:bg-white/10 hover:scale-105 transition-all duration-500 hover:border-blue-400/50">
            ...
            {/* <span className="text-sm font-medium text-gray-300">Let's Create Something Amazing</span> */}
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {[
                ...
                <div 
                  key={index} 
                  className="group relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 p-4 text-center hover:bg-white/10 hover:scale-105 hover:-translate-y-1 transition-all duration-500"
            ...
            {/* Social proof or testimonial snippet */}
